...
const CpuArchitecture = ({
  ...
  const isLongLabel = text.length > 6;
  const chipWidth = isLongLabel ? 52 : 30;
  const chipHeight = isLongLabel ? 22 : 20;
  const chipX = 100 - chipWidth / 2;
  const chipY = 50 - chipHeight / 2;
    ...
    >
      ...
      <g>
        {showCpuConnections && (
          <g fill="url(#cpu-connection-gradient)">
            ...
            <rect
              x={chipX - 3.9}
              y={chipY + chipHeight * 0.64}
              width="5"
              height="2.5"
              rx="0.7"
            />
            <rect
              x={chipX + chipWidth - 1.1}
              y={chipY + chipHeight * 0.28}
              width="5"
              height="2.5"
              rx="0.7"
        ...
        <text
          x="100"
          y={isLongLabel ? "52" : "52.5"}
          fontSize={isLongLabel ? "4.9" : "7"}
          fill={animateText ? "url(#cpu-text-gradient)" : "white"}
          fontWeight="600"
          letterSpacing="0"
          textAnchor="middle"
          textLength={isLongLabel ? 39 : undefined}
      ...
      <defs>
        ...
        <radialGradient id="cpu-blue-grad" fx="1">
          ...
          <stop offset="50%" stopColor="#f5aa28" />
        ...
        <radialGradient id="cpu-pinkish-grad" fx="1">
          ...
          <stop offset="50%" stopColor="#d65f18" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <linearGradient id="cpu-text-gradient" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#6f5730">
            <animate
          ...
          <stop offset="50%" stopColor="#6f5730">
            <animate
              attributeName="offset"
              values="0; 1; 2;"
              dur="5s"
